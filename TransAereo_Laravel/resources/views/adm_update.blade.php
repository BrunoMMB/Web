 ...
 <link rel="stylesheet" href="http://localhost:8000/template/css/style.css" type="text/css">
    ...
    <!-- Inicio do formulario -->
      <form action="{{ route('up') }}" method="POST">
        ...
        <label>Pessoa:
       	<input type="text" name="pessoa" value="{{ $user->pessoa }}"></label><br />
        <label>Nome:
        <input type="text" name="nome" value="{{ $user->nome }}"></label><br />
        <label>Funcao:
        <input type="text" name="funcao" value="{{ $user->funcao }}"></label><br />
        <label>CPF:    
        <input type="text" name="cpf" value="{{ $user->cpf }}"></label><br />
        <label>Cep:
        ...
        <label>Voo:
        <input type="text" name="voo" value="{{ $passenger }}"></label><br />
        <label>Login:
        <input type="text" name="login" value="{{ $user->login }}"></label><br />
        <label hidden>Senha:
        <input type="hidden" name="senha" value="{{ $user->senha }}"></label><br />
